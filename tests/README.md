...
| `hello-gxx-noopt.exe`                    | G++ 15.2.0         | `-O0`              |
| `hello-gxx-optsize.exe`                  | G++ 15.2.0         | `-Oz`              |
| `hello-gxx-optspeed.exe`                 | G++ 15.2.0         | `-O3`              |
...
| `switches-gcc-noopt.exe`                 | GCC 15.2.0         | `-O0`              |
| `switches-gcc-optsize.exe`               | GCC 15.2.0         | `-Oz`              |
| `switches-gcc-optspeed.exe`              | GCC 15.2.0         | `-O3`              |
